...
<body>
    ...
    $SQL = "UPDATE saida_valores SET ativo = 0 WHERE id = $id;";
    ...
    ?>
        ...
        <div class="text-center flex-column d-flex justify-content-center align-items-center divText">
